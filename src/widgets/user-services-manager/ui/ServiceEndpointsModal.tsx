...
import { useServiceValidation } from '../../../entities/service-validation';
import { useServiceJiraAccounts } from '../model/useServiceJiraAccounts';
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  onClick={() => copyToClipboard(`${baseUrl}/api/chatbot/webhook/jira`, 'webhook-endpoint')}
                  className="flex items-center space-x-1 text-sm text-gray-600 hover:text-gray-800 transition-colors"
                >
              ...
              <div className="bg-gray-50 rounded-lg p-3 font-mono text-sm text-gray-800 break-all">
                {baseUrl}/api/chatbot/webhook/jira
              </div>
              <p className="text-sm text-gray-600 mt-2">
              ...
              <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-800 mt-2">
                  <strong>Requisito:</strong> el servicio debe estar habilitado y accesible públicamente (desplegado, o expuesto con un túnel como ngrok si corres en local) para que Jira pueda enviarle las notificaciones.
                </p>
              </div>
            </div>
          </div>
