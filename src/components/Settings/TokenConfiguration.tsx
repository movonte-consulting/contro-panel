  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Jira URL */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="jiraUrl">
        ...
        {/* Jira Token */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor='jiraToken'>
        ...
        {/* OpenAI Token */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor='openaiToken'>
