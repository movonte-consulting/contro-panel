          ...
          {services.map((service) => (
            <div key={service.serviceId} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-start mb-3">
                ...
                <span className={`px-2 py-1 text-xs rounded-full ${service.approvalStatus === 'approved' && service.isActive
              ...
              {service.approvalStatus === 'approved' ? (
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded text-sm flex items-center ${service.isActive
      ...
      {selectedServiceForConfig && (
        <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 ${showProjectConfigModal ? 'block' : 'hidden'}`}>
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="currentProject">
